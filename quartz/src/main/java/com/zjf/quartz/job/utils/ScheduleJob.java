package com.zjf.quartz.job.utils;


import com.google.gson.Gson;
import com.zjf.quartz.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		IScheduleJobLogService scheduleJobLogService = (IScheduleJobLogService) SpringContextUtils.getBean("iScheduleJobLogService");
        ...
        try {
            //执行任务
			logger.info("任务准备执行，电脑是：" + context.getJobInstance());
